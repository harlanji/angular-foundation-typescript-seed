...
var mod;
function $ng() {
    return mod || (mod = angular.module('client.alertdemo', ['mm.foundation']).controller('AlertDemoCtrl', ['$scope', function ($scope) {
...
var mod;
function $ng() {
    return mod || (mod = angular.module('client.hello', []).controller('HelloCtrl', ['$scope', function ($scope) {
...
},{"./alertdemo":1,"./hello":2,"./modaldemo/index":4}],4:[function(_dereq_,module,exports){
/// <reference path="../_all.d.ts" />
...
var mod;
function $ng() {
    return mod || (mod = angular.module('client.modaldemo', ['mm.foundation']).controller('ModalDemoCtrl', ['$scope', '$modal', '$log', function ($scope, $modal, $log) {
